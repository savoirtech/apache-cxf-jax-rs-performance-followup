...
Notes: tcp_tw_reuse allows sockets in the "time-wait" state to be reused for new connections. By default, this is usually set to 0 (off), on our PPC64LE CentOS Stream 9 system its set to value 2 meaning enable for loopback traffic only.
